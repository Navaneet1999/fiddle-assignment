...
let getUniqueProductCount = listOfProducts.reduce((acc, curr)=>{
   const str = JSON.stringify(curr.productName);
   acc[str] = (acc[str] || 0) + 1;
   return acc;
}, {});
...
var result = [];
let getUniqueProduct = listOfProducts.reduce(function(res, value) {
